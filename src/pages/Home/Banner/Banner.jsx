        ...
        <div className='mb-8 relative h-[80vh]'>
            ...
            <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-r from-slate-800 w-full h-full'>
                <div className='h-full flex items-center text-white lg:p-10 p-6'>
                    <div>
                        <h2 className='text-[#fe565a] text-4xl lg:text-6xl font-bold mb-10'>Carz Zone</h2>
                        <h4 className='text-xl font-semibold mb-10 text-[#fff47f]'>Let your child explore the cars world</h4>
