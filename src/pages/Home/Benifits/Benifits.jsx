...
const Benifits = () => {
    return (
        <div className='mb-28 p-4'>
            <h2 className='lg:text-5xl text-2xl font-semibold text-center my-20'>Benefits of playing with <span className='text-red-500'>Toy Car</span></h2>
