...
const Subscription = () => {
    return (
        <div className='mb-20'>
            <h2 className='text-center font-semibold lg:text-5xl text-3xl my-16'>Check Our <span className='text-red-500'>Subscription</span></h2>
            <div class="w-full grid grid-cols-1 lg:grid-cols-3 gap-6 mx-auto p-6">
                <div class="shadow p-5 rounded-lg border-t-4 border-yellow-400 bg-white">
                    ...
                    <div class="mt-8">
                        <button class="bg-yellow-400 hover:bg-gray-500 px-3 py-2 rounded-lg w-full">
                            Create Free Listing
                        </button>
                    </div>
                </div>
